...
Frente a la congestión, una alternativa que no requiere modificaciones importantes de la infraestructura consiste en optimizar la gestión del tránsito mediante sistemas de control semafórico adaptativos. Los enfoques tradicionales presentan una capacidad limitada para responder a variaciones en el flujo vehicular. En este contexto, los avances en \gls{acr-ia} y en particular el \gls{acr-rl} permiten modelar los semáforos como agentes que aprenden políticas de control a partir de la interacción con el entorno. Las acciones corresponden a cambios de fase y la recompensa puede definirse, por ejemplo, como el negativo del tiempo de espera acumulado. Diversos estudios han mostrado la viabilidad de este enfoque, desde algoritmos tabulares aplicados a una sola intersección \cite{Wiering2000} hasta modelos de redes coordinadas basados en redes neuronales profundas y control multi-agente \cite{WeiH2019ASTSCM}.
