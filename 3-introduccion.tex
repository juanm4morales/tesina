...
La motivación de este trabajo se centra en estudiar cómo coordinar controladores que aprenden en una misma red vial. Las soluciones de control adaptativo basadas en aprendizaje por refuerzo permiten ajustar las decisiones a las condiciones observadas \cite{MDPI_Infrastructures2025_RLReview}. En una red de múltiples intersecciones, interesa examinar cómo esa adaptación puede incorporar los efectos de las decisiones locales sobre los cruces vecinos.
...
\begin{itemize}
    ...
    \item \textbf{Capítulo 2 -- Marco Teórico:} presenta los conceptos fundamentales de la ingeniería de tránsito, la teoría de procesos de decisión de Markov, las redes neuronales profundas y los paradigmas de aprendizaje por refuerzo multi-agente.
