...
La función de recompensa representa el compromiso entre el desempeño operacional local y la cooperación distribuida. El código permite evaluar varias señales de tránsito. La señal seleccionada se mantiene fija al comparar algoritmos dentro de un escenario; esta decisión experimental no implica que sea superior en todos los contextos. La Tabla \ref{tab:alternativas_recompensa} resume las alternativas implementadas.
