...
El framework \texttt{marlTLC} integra el simulador \acrshort{acr-sumo} con la librería Ray RLlib a través de la interfaz personalizada \texttt{SumoRllibEnv}. La especificación detallada de las clases y patrones de diseño orientados a objetos que sustentan esta arquitectura se expone en el Apéndice \ref{apendice:arquitectura_software}.
...
\section[Formulación del modelo Dec-POMDP]{Formulación del modelo \acrshort{acr-decpomdp}}
\label{sec:formulacion_dec_pomdp}
