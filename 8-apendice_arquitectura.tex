...
En este apéndice se documenta la especificación arquitectónica del framework \texttt{marlTLC}, su organización orientada a objetos, los diagramas de clases \acrshort{acr-uml} y los patrones de diseño previstos para desacoplar los componentes de simulación, aprendizaje por refuerzo y cálculo de recompensas. El repositorio que acompaña a este documento no contiene el código fuente completo del framework; por ello, las clases, métodos y relaciones que se presentan deben interpretarse como una especificación de diseño y no como una auditoría de archivos ejecutables.
