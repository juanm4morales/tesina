...
- For traffic dynamics, keep established terms such as `corriente de tránsito`, `condiciones de operación`, `variables principales`, `variables asociadas`, `flujo`, `densidad`, `velocidad media espacial`, `intervalo`, and `espaciamiento`.
